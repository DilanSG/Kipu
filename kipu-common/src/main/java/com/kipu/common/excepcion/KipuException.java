...
/* Excepción base personalizada para errores de negocio en Kipu.
 ...
 * Constructores:
 * - KipuException(String codigoError, String mensaje): constructor principal con código y mensaje
 * - KipuException(String codigoError, String mensaje, Throwable causa): constructor con causa para excepciones anidadas (exception chaining)
 * Uso:
...
public abstract class KipuException extends RuntimeException {
    
    private final String codigoError;
    
    // Constructor principal con código de error y mensaje descriptivo
    public KipuException(String codigoError, String mensaje) {
        super(mensaje);
    ...
    public KipuException(String codigoError, String mensaje, Throwable causa) {
        super(mensaje, causa);
        this.codigoError = codigoError;
    }
