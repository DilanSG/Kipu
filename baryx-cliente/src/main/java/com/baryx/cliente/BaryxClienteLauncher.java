...
public class BaryxClienteLauncher {

    /* Método main que se ejecuta al iniciar el cliente. Configura las propiedades del sistema para desactivar el escalado automático de Windows y luego lanza la aplicación JavaFX principal (BaryxClienteApplication).
    ...
    public static void main(String[] args) {
        ...
        BaryxClienteApplication.main(args);
    }
}
