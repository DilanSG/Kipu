...
import com.baryx.common.dto.ClienteConectadoDto;
...
/**
 * Componente reutilizable de topología de red visual para Baryx.
 *
...
public class TopologiaRed {
    ...
    private String extraerCluster(String mongoUri) {
        ...
        // mongodb+srv://***@host.mongodb.net/?appName=BaryxPC → BaryxPC
    ...
    /**
     * Consulta al servidor los clientes Baryx conectados y los dibuja
