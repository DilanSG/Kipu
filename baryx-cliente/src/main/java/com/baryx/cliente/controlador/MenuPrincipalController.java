...
import com.baryx.cliente.utilidad.MonitorConexion;
...
public class MenuPrincipalController {
    ...
    @FXML private com.baryx.cliente.componente.FondoAnimado fondoAnimado;
    ...
    */
    ...
    private void cargarVistaEnContenedor(String rutaFxml) {
        try {
            ...
            loader.setResources(com.baryx.cliente.utilidad.IdiomaUtil.obtenerBundle());
            ...
            if (controller instanceof com.baryx.cliente.controlador.facturacion.FacturacionController) {
    ...
    private void manejarNavegacionAtrasGlobal() {
        ...
        if (vistaActual == Vista.FACTURACION) {
            ...
            for (javafx.scene.Node node : contenedorPrincipal.getChildren()) {
                if (node.getUserData() instanceof com.baryx.cliente.controlador.facturacion.FacturacionController) {
                    com.baryx.cliente.controlador.facturacion.FacturacionController fc = 
                        (com.baryx.cliente.controlador.facturacion.FacturacionController) node.getUserData();
     ...
     */
    public com.baryx.common.dto.AuthRespuestaDto getUsuarioActual() {
