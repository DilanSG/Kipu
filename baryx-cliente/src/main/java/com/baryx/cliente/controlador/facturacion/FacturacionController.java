...
public class FacturacionController implements com.baryx.cliente.controlador.SubvistaController {
    ...
    public void initialize() {
        ...
        mesaServicio = new com.baryx.cliente.servicio.MesaServicio(usuarioActual.getToken());
    ...
    private Mesa convertirDtoAMesa(com.baryx.common.dto.MesaConPedidoDto dto) {
        return convertirDtoAMesa(dto, null);
    }

    private Mesa convertirDtoAMesa(com.baryx.common.dto.MesaConPedidoDto dto, String nombreMeseroFallback) {
        String nombreMesero;
