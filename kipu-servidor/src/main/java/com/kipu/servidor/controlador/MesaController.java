...
import com.kipu.servidor.servicio.MesaServicio;
...
public class MesaController {
    ...
    @PostMapping
    @PreAuthorize("hasAnyRole('MESERO', 'CAJERO', 'ADMIN')")
    public ResponseEntity<RespuestaApi<MesaConPedidoDto>> crearOObtenerMesa(@RequestBody com.kipu.common.dto.CreacionMesaDto dto) {
