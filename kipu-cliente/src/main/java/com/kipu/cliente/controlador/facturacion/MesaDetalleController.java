...
import com.kipu.cliente.modelo.LineaPedido;
...
import com.kipu.cliente.servicio.VentaServicio;
...
public class MesaDetalleController {
    ...
    public void initialize() {
        ...
        mesaServicio = new com.kipu.cliente.servicio.MesaServicio(token);
        ...
        mesaServicio.obtenerMesaConPedidoAsync(mesa.getIdMesa())
                .thenAcceptAsync(mesaDto -> {
                    if (mesaDto != null && mesaDto.getPedido() != null) {
                        ...
                        lineasPedido.clear();
                        for (com.kipu.common.dto.LineaPedidoDto lineaDto : mesaDto.getPedido().getLineas()) {
    ...
    private void guardarPedidoEnBackend() {
        ...
        java.util.List<com.kipu.common.dto.LineaPedidoDto> lineasDto = new java.util.ArrayList<>();
        for (LineaPedido linea : lineasPedido) {
            lineasDto.add(new com.kipu.common.dto.LineaPedidoDto(
                    linea.getIdProducto(),
        ...
        com.kipu.common.dto.PedidoDto pedidoDto = new com.kipu.common.dto.PedidoDto(
                lineasDto,
                totalPedido,
                LocalDateTime.now()
        );
