 ...
 */
public class ProductoCrearController implements com.kipu.cliente.controlador.SubvistaController {
    ...
    private com.kipu.cliente.servicio.CategoriaServicio categoriaServicio;
    private com.kipu.cliente.servicio.ProductoServicio productoServicio;
    ...
    public void initialize() {
        ...
        categoriaServicio = new com.kipu.cliente.servicio.CategoriaServicio("");
    ...
    public void setMenuPrincipal(MenuPrincipalController menuPrincipal) {
        ...
        if (menuPrincipal.getUsuarioActual() != null) {
            ...
            categoriaServicio = new com.kipu.cliente.servicio.CategoriaServicio(token);
    ...
    private void guardar() {
        ...
        com.kipu.common.dto.ProductoDto nuevoProducto = com.kipu.common.dto.ProductoDto.builder()
